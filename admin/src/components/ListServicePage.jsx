...
export default function ListServicePage() {
    ...
    // Converts slots map to array of slot objects
    ...
    // Parses slot string into date, time, and am/pm
    ...
    // Convert slots to formatted strings for display
    ...
    // Convert slot date/time to milliseconds
