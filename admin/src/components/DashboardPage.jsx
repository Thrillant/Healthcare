...
import { BadgeIndianRupee, Users, UserRoundCheck, CalendarRange, CheckCircle, XCircle } from "lucide-react";
        ...
        <div className={s.pageContainer}>
            <div className={s.maxWidthContainer}>
                ...
                <div className={s.statsGrid}>
                    ...
                    />
                    {/* Shows count fetched from the backend */}
    ...
    return (
        <div className={s.mobileDoctorCard}>
            ...
            <div className={s.mobileEarningsContainer}>
                ...
                <div className={s.mobileEarningsLabel}>₹ {d.earnings.toLocaleString()}</div>
                <div className={s.mobileEarningsValue}>
                    ₹ {d.earnings.toLocaleString()}
                </div>
            </div>
        </div>
