...
const Navbar = () => {
    ...
    // Toggle the mobile menu on Esc key
    useEffect(() => {
        const onKey = (e) => {
    ...
    // When user signs in, fetch a token and save it in local storage
    useEffect(() => {
        let mounted = true;
    ...
    const handleOpenSignIn = () => {
        if (!clerk || !clerk.openSignIn) {
            console.warn("Clerk not initialized properly");
            return;
        }
        clerk.openSignIn();
        navigate("/");
