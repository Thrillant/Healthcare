...
import { Users, Search, User, EyeClosed, Star, Trash, BadgeIndianRupee } from "lucide-react";

// Helper Functions
// Convert ISO 8601 to dd Mon yyyy (e.g., 25 Jul 2026)
...
// Normalize date string to YYYY-MM-DD (ISO 8601) for consistent comparison
...
// Normalize schedule map: eg- 'YYYY-MM-DD': [slot1, slot2, ...], also converts slots to array slots
...
// Get sorted schedule dates (past and future)
...
const ListPage = () => {
    ...
    // Shows all the doctors ir the filtered ones
    ...
    return (
        <div className={dls.container}>
            <header className={dls.headerContainer}>
                <div className={dls.headerTopSection}>
                    <div className={dls.headerIconContainer}>
                        ...
                        <div>
                            ...
                            <p className={dls.headerSubtitle}>Search by name or specialization</p>
                        </div>
                    </div>
                    ...
                    <div className={dls.headerSearchContainer}>
                        <div className={dls.searchBox}>
                            ...
                            <input className={dls.searchInput} value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search doctors, Specialization" />
                        </div>
                ...
                <div className={dls.filterContainer}>
                    <button onClick={() => applyStatusFilter("available")}
                        className={dls.filterButton(filterStatus === "available", "emerald")}
                    >
                        Available
                    </button>
            ...
            <main className={dls.gridContainer}>
                {loading && (
                    <div className={dls.loadingContainer}>
                        Loading Doctors...
                    </div>
                )}
                        ...
                        <article key={id} className={dls.article}>
                            <div className={dls.articleContent}>
                                {doc.imageUrl || doc.image ? (
                                    <img src={doc.imageUrl || doc.image} alt={doc.name} className={dls.doctorImage} />
                                ) : (
                                    <div className={`${dls.doctorImage} bg-emerald-100 flex items-center justify-center shrink-0`}>
                                    ...
                                    <div className={dls.statsContainer}>
                                        ...
                                        <div className={dls.actionContainer}>
                                            <div className="flex items-center gap-2">
                                                <button onClick={() => removeDoctor(id)} className={dls.deleteButton}>
                                ...
                                {isOpen && (
                                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                        <div className={dls.aboutSection}>
                                            ...
                                            <div className="mt-4">
                                                <div className={dls.scheduleHeading}>
                                                    Schedule
                                                </div>
                                        ...
                                        <aside className={dls.statsSidebar}>
                                            <div className={dls.statsItemHeading}>
                                                Success
                                            </div>
                                            <div className={dls.statsItemValue}>
                                                {doc.success}%
                                            </div>
