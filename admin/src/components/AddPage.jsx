...
import { EyeClosed, Eye, User, XCircle, Calendar, Plus, Trash2, CheckCircle } from "lucide-react";

// Helper Functions
// Gives outputs in minutes and according to that it will give AM/PM
...
// Converts (YYYY-MM-DD) → (DD Mon YYYY)
...
const AddPage = () => {
    ...
    // Computes today's date in local timezone
    ...
    function addSlotToForm() {
        ...
        // Prevent adding past times today
        if (slotDate === today) {
            const now = new Date();
    ...
    // Flattens the schedule object into an array of { date, time } objects
    ...
    // Handles the form submission to add a doctor
