...
// Helper Functions
// Converts array like inputs into a clean array
...
// Takes date-time slot strings and group them into a "YYYY-MM-DD" with the time
...
export async function createService(req, res) {
    try {
        ...
        } // If the file is present it will be uploaded to services folder in cloudinary
            ...
            try {
                ...
                if (up?.secure_url) {
                    ...
                    if (existing.imagePublicId) {
                        // Remove the old image and replace it with the new image
                        try {
