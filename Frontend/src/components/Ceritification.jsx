                    ...
                    <div className={cs.logosInner}>
                        <div className={cs.logosFlexContainer}>
                            <div className={cs.logosMarquee}>
                                {duplicatedCertifications.map((c, i) => (
                                    <div key={`c-${c.id}-${i}`} className={cs.logoItem}>
                                        <div className="relative">
                                            <img src={c.image} alt={c.name} className={cs.logoImage} />
                                        </div>
                                        <span className={cs.logoText}>{c.name}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
