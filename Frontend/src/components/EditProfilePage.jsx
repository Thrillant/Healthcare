...
import { editProfilePageStyles as eps, iconSize } from "../assets/dummyStyles";

const STORAGE_KEY = "doctorToken_v1";

// Parsing 12-hour time to minutes
...
// Deduplicating and sorting schedule
                    ...
                    <div className={styles.headerBackground}>
                        <div className={styles.imageContainer}>
                            <div className={styles.imageWrapper}>
                                <img
                                    src={imagePreview || "data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="}
                                    alt={doc.name}
                                    className={styles.profileImage}
                                    onError={(e) => {
                                        e.currentTarget.onerror = null;
                                        e.currentTarget.src = "data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==";
                                    }}
                                />
